...
# Generated on: Wed May 27 11:42:18 IST 2026 (Wed May 27 06:12:18 UTC 2026)
...
read_implementation_information fv/viterbi_k7 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/run/media/ccoew/_DATA/cadence/GENUS201/tools.lnx86"
set CDN_SYNTH_ROOT      "/run/media/ccoew/_DATA/cadence/GENUS201/tools.lnx86"
set env(CW_DIR) "/run/media/ccoew/_DATA/cadence/GENUS201/tools.lnx86/lib/chipware"
set CW_DIR      "/run/media/ccoew/_DATA/cadence/GENUS201/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /run/media/ccoew/_DATA/cadence/SCLPDK_V3.0_KIT /scl180/stdcell/fs120/6M1L/liberty/lib_flow_ff /run/media/ccoew/_DATA/cadence/SCLPDK_V3.0_KIT scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss -library -both
read_library -liberty -both /run/media/ccoew/_DATA/cadence/SCLPDK_V3.0_KIT/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss/tsl18fs120_scl_ss.lib /run/media/ccoew/_DATA/cadence/SCLPDK_V3.0_KIT/scl180/iopad/cio150/6M1L/liberty/tsl18cio150_max.lib
...
add_search_path /run/media/ccoew/_DATA/cadence/Viterbi_Decoder/synthesis/viterbi_k7.v -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  viterbi_k7.v
elaborate_design -golden -root {viterbi_k7} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/viterbi_k7/fv_map.v.gz
elaborate_design -revised -root {viterbi_k7}
...
#add_name_alias fv/viterbi_k7/fv_map.singlebit.original_name.alias.json.gz -revised
